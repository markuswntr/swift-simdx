...
STATIC_INLINE_INTRINSIC(CXInt32x3) CXInt32x3Load(const void* pointer)
{
    CXInt32x3 storage = vld1q_s32((Int32*)pointer);
    storage[3] = 0.f;
    return storage;
}
...
STATIC_INLINE_INTRINSIC(CXInt32x3) CXInt32x3Absolute(CXInt32x3 storage)
{
