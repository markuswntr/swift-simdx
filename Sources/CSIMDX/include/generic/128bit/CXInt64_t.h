...
typedef Int64 CEXStorageInt64x2 __attribute__((ext_vector_type(2)));
typedef Int64 CEXStorageInt64x3 __attribute__((ext_vector_type(3)));
typedef Int64 CEXStorageInt64x4 __attribute__((ext_vector_type(4)));
#endif
...
#if __has_extension(attribute_ext_vector_type)
    CEXStorageInt64x2 internalElements;
#endif
} CXInt64x2;
...
#if __has_extension(attribute_ext_vector_type)
    CEXStorageInt64x3 internalElements;
#endif
} CXInt64x3;
...
#if __has_extension(attribute_ext_vector_type)
    CEXStorageInt64x4 internalElements;
#endif
} CXInt64x4;
