...
// MARK: - Float32x3 register type -

/// 128bit floating point intrinsic. The first Float32 is stored in the lowest 32 bits, and so on.
/// Last Float32 is unused and "zero-ed out".
typedef __m128 CXFloat32x3;
...
STATIC_ALWAYS_INLINE(CXFloat32x3)
...
/// Creates a three-part mask based on component-wise == compares of the input vectors
/// @param lhs 1st vector
/// @param rhs 2nd vector
STATIC_ALWAYS_INLINE(CXFloat32x3)
CXFloat32x3Equal(const CXFloat32x3 lhs, const CXFloat32x3 rhs)
{
