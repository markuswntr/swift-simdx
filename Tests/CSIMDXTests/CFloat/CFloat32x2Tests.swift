...
final class CFloat32x2Tests: XCTestCase {
  ...
  func testMagnitude() {
    let normal = CFloat32x2Make(-1, 3)
    let absolute = CFloat32x2Magnitude(normal)
  ...
  func testConvertFromFloat64x2() {
    let fromStorage = CFloat64x2Make(2.11199999999999, 1.54321987654321)
    let storage = CFloat32x2FromCFloat64x2(fromStorage)
