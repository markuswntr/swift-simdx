...
STATIC_INLINE_INTRINSIC(CXFloat32x4) CXFloat32x4Load(const void* pointer)
{
    return vld1q_f32((Float32*)pointer);
}
...
STATIC_INLINE_INTRINSIC(CXFloat32x4) CXFloat32x4Absolute(CXFloat32x4 storage)
{
